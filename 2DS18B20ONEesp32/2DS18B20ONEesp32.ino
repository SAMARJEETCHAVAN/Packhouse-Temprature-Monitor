...
void loop(void){
  ...
  while (WiFi.status() != WL_CONNECTED) {
    ...
    String httpRequestData = "api_key=tPmAT5Ab3j7F9&timedate="+String(timeClient.getFormattedTime())+"&siteLocation="+siteLocation+"&T1=404.00&H1=404.00&T2=404.00&H2=404.00&T3="+String((sensors.getTempC(sensor1)))+"&H3=404.00&T4=404.00&H4=404.00&T5=404.00&H5=404.00&T6="+String((sensors.getTempC(sensor2)))+"&H6=404.00&T7=404.00&H7=404.00&T8=404.00&H8=404.00&T9=404.00&H9=404.00&T10=404.00&H10=404.00&T11=404.00&H11=404.00&T12=404.00&H12=404.00&T13=404.00&H13=404.00&MAC="+String(WiFi.macAddress());
